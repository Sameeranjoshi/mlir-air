...
csl.wafer @w {arch = "wse3"} {
  csl.program @sender {
    ...
    // CHECK-DAG: csl.task @ch1_put_done_0 attributes {id = 8 : i32, trigger_kind = "local_task_id"}
    // CHECK-DAG: csl.task @ch2_put_done_1 attributes {id = 9 : i32, trigger_kind = "local_task_id"}
  }
