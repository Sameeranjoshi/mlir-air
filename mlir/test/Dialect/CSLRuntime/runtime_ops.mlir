...
func.func @test_runtime_ops() {
  ...
  %d2h = csl_rt.memcpy_d2h %h2d "dest_data" from (0, 0) with_size (16, 16) elem_per_pe 256 : (!csl_rt.runtime) -> !csl_rt.runtime
  // CHECK: %[[D2H:.*]] = csl_rt.memcpy_d2h %[[H2D]] "dest_data" from (0, 0) with_size (16, 16) elem_per_pe 256 : (!csl_rt.runtime) -> !csl_rt.runtime
