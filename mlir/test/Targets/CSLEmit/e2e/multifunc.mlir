...
// RUN: FileCheck --check-prefix=PLAIN %s < %t/plain_vecadd/pe.csl
// RUN: FileCheck --check-prefix=HELPER %s < %t/helper_add/pe.csl
//
// Two wafers in one module:
//   plain_vecadd — simple vecadd; checks layout_mod and fn compute.
//   helper_add   — func.func private helper; checks helper emission, func.call,
//                  func.return, and <layout> auto-import.
